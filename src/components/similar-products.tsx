  ...
  return (
    <div className="relative">
      <div
        ...
        className="flex overflow-x-auto gap-6 py-4 px-15 scrollbar-hide snap-x snap-mandatory"
      ...
      >
        {products.map((product) => (
          ...
          //   </div>
          // </Link>
          <ProductCard key={product.id} id={product.id} imageSrc={product.images[0]} name={product.name} price={product.price} sku={product.sku} numericPrice={product.price}></ProductCard>
        ))}
      </div>
